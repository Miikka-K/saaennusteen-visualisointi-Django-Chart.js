...
1. Koko suomen kaupunkien lisääminen sovellukseen, esimerkiksi käyttäen CSV-tiedostoja hyväksi.
2. Näytä tuntikohtainen sateen mahdollisuus ja tuulen nopeus.
3. LÄMPÖTILA NYT, näyttää virheellisesti päivän korkeimman lämpötilan, eikä tämänhetkistä lämpötilaa.
